...
import com.sai.incubation.IotConnector.constants.EmailConstant;
...
public class EmailService {
	...
	public void sendNewPasswordEmail(String firstName, String password, String email) throws MessagingException {
		...
		SMTPTransport smtpTransport = (SMTPTransport) getEmailSession().getTransport(EmailConstant.SMT_PROTOCOL);
